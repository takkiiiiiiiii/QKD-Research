...
#=======================================================#
def transmissivity_etab_eliptic(beam_centroid_displacement, chi, w_1, w_2):
    eta_0 = transmissivity_0_eliptic(w_1, w_2)
...
# Transmissivity nb(eta_b)
#=======================================================#
def transmissivity_etab_eliptic(beam_centroid_displacement, chi, w):
    eta_0 = transmissivity_0_circle(w)
    exp_term = np.exp(-(beam_centroid_displacement/r_scale(2/W_eff(chi, w_1, w_2)))**lambda_shape(2/W_eff(chi, w_1, w_2)))
    eta = eta_0 * exp_term
    return eta
#=======================================================#
...
# centered beam
#=======================================================#
def transmissivity_0_eliptic(w_1, w_2):
    inv_W1_sq = 1 / w_1**2
    # print(inv_W1_sq)
    inv_W2_sq = 1 / w_2**2
    # print(inv_W2_sq)
